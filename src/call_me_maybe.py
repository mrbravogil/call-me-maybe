...
class CallMeMaybe(BaseModel):
    ...
    def set_arguments_intructions(self, func: FunctionDefinition) -> None:
        ...
        instructions: str = (
            ...
            'Copy string values exactly from the user request when present.\n'
            'Preserve exact spelling, casing, and plurality.\n'
            'Do not paraphrase string values.\n'
            'If the user says NUMBERS, return "NUMBERS", not "NUMBER".\n'
            ...
            'If the request says "Reverse the string "hello"", '
            'return { "arguments": { "s": "hello" }.\n'
